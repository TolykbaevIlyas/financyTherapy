  ...
  return (
    <ContainerWrapper>
      ...
      >
        ...
        <p className="text-[20px] font-normal text-[#535862]">
          Разнообразие успешных кейсов
        </p>
      </motion.div>
      ...
      <div className="relative">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="pointer-events-none absolute bottom-0 left-0 w-full h-[320px] bg-gradient-to-t from-white to-transparent"
        />
      </div>
    </ContainerWrapper>
  );
