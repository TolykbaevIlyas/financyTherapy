        ...
        <ContainerWrapper>
            <div className='flex flex-col gap-[64px]'>
                <div className='flex flex-col gap-[24px]'>
                    <h3 className='max-w-[1024px] w-full m-auto text-[60px] leading-[120%] text-[#181d27] font-[600]'>КАК В МЕДИЦИНЕ — СНАЧАЛА К ТЕРАПЕВТУ, ПОТОМ К СПЕЦИАЛИСТУ</h3>
                    <p className='text-[20px] leading-[150%] font-[400] text-[#535862]'>ИСПОЛЬЗУЕМ МЕДИЦИНСКИЙ ПОДХОД К ФИНАНСОВОМУ ОЗДОРОВЛЕНИЮ</p>
                </div>
                <div className='flex justify-center'>
                    ...
                    <div className='h-[211px] border-[1px] border-[#e9eaeb]'></div>
                    <div className=' flex flex-col gap-[24px] max-w-[568px] w-full'>
