      ...
      <ContainerWrapper>
        <section className="w-full bg-white mt-[96px] mb-[64px] grid md:grid-cols-2 gap-5 items-start">
          ...
          <div className="max-w-[690px] w-full">
            ...
            >
              <p className="w-full">
                «Я не теоретик из бизнес-школы. 38 миллионов рублей собственной задолженности — это
              ...
              <p className="w-full">
                После того как смог выбраться из этой ситуации, понял важную вещь: большинство людей
                можно уберечь от банкротства и разорения при комплексном анализе ситуации и выборе
              ...
              <p className="w-full">
                Более 1500 человек уже получили персональные планы и решили свои финансовые
            ...
            >
              <p>
                Моя история: «Я не теоретик из университета. 38 миллионов рублей собственного долга
              ...
              <p>
                После того как выбрался сам, понял: 90% людей можно спасти от банкротства при
                правильной диагностике. Но никто этого не делает — все продают то, что им САМИМ
                выгодно.
              </p>
              <p>
                1500+ наших клиентов уже получили персональные планы спасения. 8 из 10 избежали
                банкротства. Система работает.»
              </p>
            </motion.div>
          </div>
